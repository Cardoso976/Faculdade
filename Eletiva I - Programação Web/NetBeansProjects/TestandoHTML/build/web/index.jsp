        ...
        <nav>
            ...
            <section>
              ...
              if(session.getAttribute("login")==null){
                out.println("<h2>Ola, Visitantes! "+
                            "<a href = login.jsp> Clique aqui </a>"+
                            "para fazer login na loja. </h2>");
              }
              else{
                String login = (String)session.getAttribute("Login");
                out.println("<h2> Bem Vindo(a) de volta "+login+"!");
              }
              %>
                <h2>Nossos Produtos</h2>
                <div id="p1">
                    Produto 1 - Beck de Seda do Taiwan
                    <ul>
                        <li>Mais Econômico</li>
                        <li>Alta Durabilidade</li>
                        <li>Proteje o Meio-Ambiente</li>
                    </ul>
                </div>
                <div id="p2">
                    Produto 2 - Pó de Narnia
                    <ol>
                        <li>Brilhante</li>
                        <li>Tem uma Coloração Estranha</li>
                        <li>Faz ver Gnomos Cabulosos</li>
                    </ol>
                </div>
            </section>
        <footer>
